def help
    ...
    puts "      Listing thier name, identity and superpowers"
    ...
    puts "    - Edit superhero information with this option. First seach and then select a particular superhero"
